...
class EmailService {
  ...
  static async sendVerificationEmail(user, verificationLink) {
    ...
    return this._sendEmail(user, TEMPLATES.VERIFY_EMAIL, "Verify Your email address", variables);
  }
  ...
  static async sendPasswordResetEmail(user, resetLink) {
    ...
    return this._sendEmail(user, TEMPLATES.RESET_PASSWORD, "Password Reset Request", variables);
  }
  ...
  static async sendOrderPlacedEmail(user, order) {
    ...
    return this._sendEmail(user, TEMPLATES.ORDER_PLACED, "Order confirmation", variables);
  }
  ...
  static async sendOrderIsOnTheWayEmail(user, order) {
    ...
    return this._sendEmail(user, TEMPLATES.ORDER_ON_WAY, "Your order is on the way", variables);
  }
