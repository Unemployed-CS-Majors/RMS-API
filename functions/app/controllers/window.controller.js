...
class WindowController {
  ...
  static async getAllWindows(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Windows fetched successfully", windows));
    } catch (error) {
  ...
  static async createWindow(req, res) {
    ...
    try {
      ...
      return res
        .status(201)
        .json(createResponse("success", "Window created successfully", { id: newWindowId }));
    } catch (error) {
  ...
  static async updateWindow(req, res) {
    ...
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Window updated successfully", updatedWindow));
    } catch (error) {
