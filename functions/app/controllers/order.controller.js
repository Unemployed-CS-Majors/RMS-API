...
class OrderController {
  ...
  static async createOrder(req, res) {
    try {
      ...
      if (createdOrder.paymentMethod === PaymentMethod.ONLINE) {
        ...
        await OrderService.updateOrderStatus(createdOrder.id, OrderStatus.PAID);
      ...
      return res
        .status(201)
        .json(createResponse("success", "Order created successfully", createdOrder));
    } catch (error) {
  ...
  static async getUserOrders(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Order retrieved successfully", orders));
    } catch (error) {
  ...
  static async updateOrderStatus(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Order updated successfully", updatedOrder));
    } catch (error) {
  ...
  static async cancelOrder(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Order cancelled successfully", canceledOrder));
    } catch (error) {
  ...
  static async getAllOrders(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Orders retrieved successfully", orders));
    } catch (error) {
