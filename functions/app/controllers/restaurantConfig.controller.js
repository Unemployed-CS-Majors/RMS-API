...
class RestaurantConfigController {
    static async addPhoneNumber(req, res) {
        try {
            ...
            return res.status(201).json(createResponse("success", "Phone number added successfully", null));
        } catch (error) {
    ...
    static async updatePhoneNumber(req, res) {
        try {
            ...
            return res.status(200).json(createResponse("success", "Phone number updated successfully", null));
        } catch (error) {
            return res.status(500).json(createResponse("error", error.message, null));
        }
    }
    ...
    static async deletePhoneNumber(req, res) {
        try {
            ...
            return res.status(200).json(createResponse("success", "Phone number deleted successfully", null));
        } catch (error) {
            return res.status(500).json(createResponse("error", error.message, null));
        }
    }
    ...
    static async getPhoneNumber(req, res) {
        try {
            ...
            return res.status(200).json(createResponse("success", "Phone number fetched successfully", phoneNumber));
        } catch (error) {
            return res.status(500).json(createResponse("error", error.message, null));
        }
    }
    ...
    static async getAddress(req, res) {
        try {
            ...
            return res.status(200).json(createResponse("success", "Address fetched successfully", address));
        } catch (error) {
            return res.status(500).json(createResponse("error", error.message, null));
        }
    }
    ...
    static async getRestaurantConfig(req, res) {
        try {
            ...
            return res.status(200).json(createResponse("success", "Restaurant config fetched successfully", config));
        } catch (error) {
            return res.status(500).json(createResponse("error", error.message, null));
        }
    }
