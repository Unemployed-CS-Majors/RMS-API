...
class AnalyticsController {
  ...
  static async getRevenueAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve revenue analytics", error.message));
    }
  }
  ...
  static async getMenuItemAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve menu item analytics", error.message));
    }
  }
  ...
  static async getReservationAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve reservation analytics", error.message));
    }
  }
  ...
  static async getOrderStatusAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve order status analytics", error.message));
    }
  }
  ...
  static async getCustomerAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve customer analytics", error.message));
    }
  }
  ...
  static async getOperationalAnalytics(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve operational analytics", error.message));
    }
  }
  ...
  static async getDashboardSummary(req, res) {
    try {
      ...
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve dashboard summary", error.message));
    }
  }
  ...
  static async getAllAnalytics(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "All analytics retrieved successfully", allAnalytics));
    } catch (error) {
      logger.error("Error in getAllAnalytics controller:", error);
      return res
        .status(500)
        .json(createResponse("error", "Failed to retrieve analytics", error.message));
    }
  }
}
