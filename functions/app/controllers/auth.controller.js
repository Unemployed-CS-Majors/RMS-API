...
class AuthController {
  static async register(req, res) {
    ...
    if (result.success) {
      ...
      res
        .status(201)
        .json(createResponse("success", "User registered successfully", { uid: result.uid }));
    } else {
  ...
  static async createEmployee(req, res) {
    ...
    if (result.success) {
      ...
      res
        .status(201)
        .json(createResponse("success", "Employee created successfully", { uid: result.uid }));
    } else {
  ...
  static async createOwner(req, res) {
    ...
    if (result.success) {
      ...
      res
        .status(201)
        .json(createResponse("success", "Owner created successfully", { uid: result.uid }));
    } else {
  ...
  static async googleAuth(req, res) {
    ...
    if (result.success) {
      ...
      res.status(200).json(
        createResponse("success", "Google sign-in successful", {
          uid: result.uid,
          idToken: result.idToken,
          refreshToken: result.refreshToken,
        }),
