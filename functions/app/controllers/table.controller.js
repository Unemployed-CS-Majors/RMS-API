...
class TableController {
  ...
  static async createTable(req, res) {
    ...
    try {
      ...
      return res
        .status(201)
        .json(createResponse("success", "Table created successfully", { id: newTable }));
    } catch (error) {
  ...
  static async updateTable(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Table updated successfully", updatedTable));
    } catch (error) {
  ...
  static async deactivateTable(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Table deactivated successfully", updatedTable));
    } catch (error) {
  ...
  static async activateTable(req, res) {
    try {
      ...
      return res
        .status(200)
        .json(createResponse("success", "Table activated successfully", updatedTable));
    } catch (error) {
