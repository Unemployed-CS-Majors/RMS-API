...
class FirebaseLogger {
    ...
    _logToCloud(level, message, data) {
        ...
        switch (level) {
            case LogLevel.DEBUG: debug(logMessage, logData); break;
            case LogLevel.INFO: info(logMessage, logData); break;
            case LogLevel.WARN: warn(logMessage, logData); break;
            case LogLevel.ERROR: error(logMessage, logData); break;
            default: write(logMessage, logData);
        }
    }
