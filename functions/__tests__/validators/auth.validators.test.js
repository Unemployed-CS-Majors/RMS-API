...
describe('Auth Validators', () => {
    ...
    describe('validateLogin', () => {
        it('should handle edge cases in login data', () => {
            ...
            const req1 = {
                body: {
                    email: 'very.long.email.address.that.is.still.technically.valid.according.to.rfc5322@example.com',
                    password: 'password123'
                }
            };
    ...
    describe('isValidEmail', () => {
        ...
        it('should handle edge cases in email validation', () => {
            ...
            const longEmail = 'very.long.email.address.that.is.still.technically.valid.according.to.rfc5322@example.com';
