...
describe('MenuItem Validators', () => {
    ...
    describe('validateDescription', () => {
        ...
        it('should validate any description', () => {
            expect(validateDescription('Delicious pizza with tomato sauce and mozzarella')).toEqual({ isValid: true });
    ...
    describe('validateAllergens', () => {
        it('should validate valid allergen arrays', () => {
            ...
            expect(validateAllergens(JSON.stringify([Allergen.NUTS, Allergen.PEANUTS]))).toEqual({ isValid: true });
    ...
    describe('validateMenuItem', () => {
        ...
        it('should collect all validation errors for an invalid menu item', () => {
            ...
            expect(result.errors).toContain(`Invalid allergens: invalid_allergen. Valid options are: ${Object.values(Allergen).join(', ')}`);
        });
    });
});