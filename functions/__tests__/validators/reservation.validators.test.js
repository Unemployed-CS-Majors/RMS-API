...
describe('Reservation Validators', () => {
    describe('validateCreateReservation', () => {
        ...
        it('should reject when time format is invalid', () => {
            ...
            expect(validateCreateReservation(req1)).toBe('Start and end time must be valid ISO 8601 date-time strings');
            ...
            expect(validateCreateReservation(req2)).toBe('Start and end time must be valid ISO 8601 date-time strings');
        });
    ...
    describe('validateTimeFormat', () => {
        ...
        it('should reject when time format is invalid or missing', () => {
            ...
            // Non-ISO 8601 format
            expect(validateTimeFormat('01/12/2023 18:00')).toBe('Time must be a valid ISO 8601 date-time string');

            // Invalid date
            expect(validateTimeFormat('2023-13-01T18:00:00Z')).toBe('Time must be a valid ISO 8601 date-time string');
        });
    });
