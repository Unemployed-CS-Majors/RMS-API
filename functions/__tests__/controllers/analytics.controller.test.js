...
describe('Analytics Controller', () => {
    ...
    describe('getRevenueAnalytics', () => {
        it('should return revenue analytics with default 30 days period', async () => {
            ...
            const mockAnalyticsData = {
                ...
                dailyRevenue: { '2023-10-01': 425.50, '2023-10-02': 825.25 },
                weeklyRevenue: { '2023-09-25': 1250.75 },
                revenueByPaymentMethod: { online: 750.25, cash_on_delivery: 250.50, in_store: 250.00 },
                revenueByDeliveryMethod: { home_delivery: 1000.75, pickup: 250.00 },
        ...
        it('should use custom days period from query params', async () => {
            ...
            // Mock service response
            const mockAnalyticsData = { totalRevenue: 3500.00 };
            AnalyticsService.getRevenueAnalytics.mockResolvedValue(mockAnalyticsData);
    ...
    describe('getMenuItemAnalytics', () => {
        it('should return menu item analytics with default 30 days period', async () => {
            ...
            const mockAnalyticsData = {
                topItems: [
                    { id: 'item1', name: 'Pizza', totalQuantity: 150, totalRevenue: 2250.00 },
                    { id: 'item2', name: 'Burger', totalQuantity: 120, totalRevenue: 1440.00 }
                ],
                bottomItems: [
                    { id: 'item3', name: 'Salad', totalQuantity: 35, totalRevenue: 350.00 },
                    { id: 'item4', name: 'Soup', totalQuantity: 42, totalRevenue: 336.00 }
                ],
                itemsByQuantity: { item1: 150, item2: 120, item3: 35, item4: 42 },
                itemsByRevenue: [
                    { id: 'item1', name: 'Pizza', totalRevenue: 2250.00 },
                    { id: 'item2', name: 'Burger', totalRevenue: 1440.00 },
                    { id: 'item3', name: 'Salad', totalRevenue: 350.00 },
                    { id: 'item4', name: 'Soup', totalRevenue: 336.00 }
                ],
    ...
    describe('getCustomerAnalytics', () => {
        it('should return customer analytics with default 90 days period', async () => {
            ...
            const mockAnalyticsData = {
                ...
                topCustomers: [
                    { userId: 'user1', name: 'John Doe', email: 'john@example.com', orderCount: 12, totalSpent: 950.50 },
                    { userId: 'user2', name: 'Jane Smith', email: 'jane@example.com', orderCount: 10, totalSpent: 875.25 }
                ]
            };
            ...
            // Assertions
            expect(AnalyticsService.getCustomerAnalytics).toHaveBeenCalledWith(90); // Default is 90 for customer analytics
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.json).toHaveBeenCalledWith({
                status: 'success',
    ...
    describe('getOperationalAnalytics', () => {
        it('should return operational analytics', async () => {
            ...
            const mockAnalyticsData = {
                ...
                tables: [{id: 1, seats: 4}, {id: 2, seats: 6}],
    ...
    describe('getAllAnalytics', () => {
        it('should return all analytics with default 30 days period', async () => {
            // Setup mock request and response
            const req = mockRequest({
                query: {}
            });
            ...
            const mockAnalyticsData = {
                ...
                menuItemAnalytics: {
                    topItems: [{ name: 'Pizza', totalQuantity: 150 }]
                },
                reservationAnalytics: {
                    totalReservations: 125
                },
                orderStatusAnalytics: {
                    ordersByStatus: { completed: 120 }
                },
                customerAnalytics: {
                    totalCustomers: 350
                },
                operationalAnalytics: {
                    currentStats: { activeTables: 25 }
                }
            };

            AnalyticsService.getAllAnalytics.mockResolvedValue(mockAnalyticsData);

            // Call controller method
            await AnalyticsController.getAllAnalytics(req, res);

            // Assertions
            expect(AnalyticsService.getAllAnalytics).toHaveBeenCalledWith(30);
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.json).toHaveBeenCalledWith({
                status: 'success',
        ...
        it('should use custom days period from query params', async () => {
            ...
            // Assertions
            expect(AnalyticsService.getAllAnalytics).toHaveBeenCalledWith(60);
            expect(res.status).toHaveBeenCalledWith(200);
        });
        ...
        it('should handle errors and return 500 status', async () => {
            ...
            // Mock service to throw error
            const error = new Error('Failed to retrieve analytics');
            AnalyticsService.getAllAnalytics.mockRejectedValue(error);
            ...
            // Assertions
            expect(logger.error).toHaveBeenCalledWith(
                "Error in getAllAnalytics controller:",
                expect.any(Error)
            );
            expect(res.status).toHaveBeenCalledWith(500);
            expect(res.json).toHaveBeenCalledWith({
