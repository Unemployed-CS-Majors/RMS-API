...
describe('Email Service', () => {
    let mockUser, mockReservation, mockOrder;
    ...
    describe('sendReservationEmail', () => {
        it('throws error for invalid reservation status', async () => {
            await expect(EmailService.sendReservationEmail(mockReservation, mockUser, 'invalid'))
    ...
    describe('sendVerificationEmail', () => {
        it('sends verification email successfully', async () => {
            const result = await EmailService.sendVerificationEmail(mockUser, 'https://example.com/verify');
    ...
    describe('sendPasswordResetEmail', () => {
        it('sends password reset email successfully', async () => {
            const result = await EmailService.sendPasswordResetEmail(mockUser, 'https://example.com/reset');
            expect(result.body.success).toBe(true);
        });
    });
