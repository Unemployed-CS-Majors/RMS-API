...
describe('User Service', () => {
    ...
    describe('getUser', () => {
        it('retrieves a user by ID successfully', async () => {
            const userData = { id: 'user1', firstName: 'John', lastName: 'Doe', email: 'john.doe@example.com' };
            const mockUserRef = { get: jest.fn().mockResolvedValue(mockDocumentSnapshot('user1', userData)) };
