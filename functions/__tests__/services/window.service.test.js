...
describe('Window Service', () => {
    ...
    describe('getWindow', () => {
        it('retrieves a window by ID successfully', async () => {
            ...
            const mockWindowRef = { get: jest.fn().mockResolvedValue(mockDocumentSnapshot('window1', windowData)) };
    ...
    describe('getAllWindows', () => {
        it('retrieves all windows successfully', async () => {
            ...
            expect(result).toEqual(windowsData.map(data => Window.fromFirestore(mockDocumentSnapshot(data.id, data))));
        });
    });
    ...
    describe('updateWindow', () => {
        it('updates a window successfully', async () => {
            ...
            const mockWindowRef = { update: jest.fn().mockResolvedValue({}), get: jest.fn().mockResolvedValue(mockDocumentSnapshot('window1', windowData)) };
            db.collection.mockReturnValue({ doc: jest.fn().mockReturnValue(mockWindowRef) });
