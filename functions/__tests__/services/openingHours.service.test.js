...
describe('OpeningHours Service', () => {
    ...
    describe('getOpeningHoursById', () => {
        it('retrieves opening hours by ID', async () => {
            ...
            const mockDocRef = { get: jest.fn().mockResolvedValue(mockDocumentSnapshot('1', mockOpeningHours)) };
            ...
            expect(result).toEqual(OpeningHours.fromFirestore(mockDocumentSnapshot('1', mockOpeningHours)));
        });
    ...
    describe('createOpeningHours', () => {
        ...
        it('throws an error if the counter document does not exist', async () => {
            ...
            await expect(OpeningHoursService.createOpeningHours({ day: 'Monday', startTime: '09:00', endTime: '17:00' }))
    ...
    describe('updateOpeningHours', () => {
        it('updates existing opening hours', async () => {
            ...
            const mockDocRef = { update: jest.fn(), get: jest.fn().mockResolvedValue(mockDocumentSnapshot('1', mockOpeningHours)) };
            db.collection.mockReturnValue({ doc: jest.fn().mockReturnValue(mockDocRef) });

            const result = await OpeningHoursService.updateOpeningHours('1', new OpeningHours('1', 'Monday', '09:00', '17:00'));
