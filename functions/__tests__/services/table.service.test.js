...
describe('Table Service', () => {
    ...
    describe('getTable', () => {
        it('retrieves a table by ID successfully', async () => {
            ...
            const mockTableRef = { get: jest.fn().mockResolvedValue(mockDocumentSnapshot('table1', tableData)) };
    ...
    describe('getAllTables', () => {
        it('retrieves all tables successfully', async () => {
            ...
            expect(result).toEqual(tablesData.map(data => Table.fromFirestore(mockDocumentSnapshot(data.id, data))));
        });
    });
